...
class GenerativeModel:
    ...
    def GEM_draw(self, m, pi):
        ...
        # Trunacated stick breaking; set the last value so the probs sum to one
...
# Hyperparmeters
ETA = [0.005] * VOCAB_SIZE 
gamma = 1.0
m = 0.8
pi = 100

# Create a vocab of VOCAB_SIZE words
vocab_filename = "/home/genevieve/mit-whoi/hlda/dataset-ap/vocab.txt"
