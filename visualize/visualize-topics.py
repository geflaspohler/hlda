...
class Corpus:
    ...
    def calc_purity(self, top_words, N):
        ...
        top_purity = np.array(purity)[top_docs]
        #print "top documents:", top_docs
        return top_docs[0:N], top_purity[0:N]
...
if __name__ == "__main__":
    ...
    for index, topic_group in enumerate([top_one, top_two]):
        for topic in topic_group:
            ...
            print top_words
            top_docs, top_purity = corpus.calc_purity(top_words, N = 50);
            ...
            for i, doc in enumerate(top_docs):
                purity_string = "%.2f" % top_purity[i]
                img = str(i)+ '_' + str(purity_string) + '_' + image_files[doc]
